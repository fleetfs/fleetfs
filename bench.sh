...
fio --name read-test --eta-newline=5s --filename=${BASELINE_DIR}/fio-tempfile.dat --rw=read --size=500m --io_size=10g --blocksize=8k \
...
fio --name read-test --eta-newline=5s --filename=${DIR}/fio-tempfile.dat --rw=read --size=500m --io_size=10g --blocksize=8k \
    --ioengine=libaio --fsync=1000 --iodepth=32 --direct=1 --numjobs=1 --runtime=20 --group_reporting
